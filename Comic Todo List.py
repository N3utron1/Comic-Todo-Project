...
#Todo:
#Reformat with code style.
#Clear unneeded comments.
#Add readme.

root = ttk.Window(themename = 'journal')
root.title('Comic Todo List!')
...
def show_notification(message):
    ...
    popup.geometry("200x100+500+300")  # Adjust size and position
...
def positive_notification():
	random_number = random.randint(1, 5)
	positive_message = "a"
	match random_number:
		case 1:
			positive_message = "Good Job!"
		case 2:
			positive_message = "You did it!"
		case 3:
			positive_message = "Lets Goooooo!"
		case 4:
			positive_message = "Congrats!"
		case 5:
			positive_message = "Yay!"
	
	show_notification(positive_message)
